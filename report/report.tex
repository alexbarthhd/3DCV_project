...
modify roi
HLP Parameter, threshold, maxLineGap: Abstand zwischen Endpunkten Fahrbahn Bildmitte, minLL: hoch genug, um Rad (RU) nicht als Kante zu erkennen
HL works column-rise, lt to rb -> splitted

rot, pink: Mittelwerte, grün, blau: alle Arrays
gelb: direction (where to go), lower: mid, upper: mitte der strecke beider Endpunkte, wenn 1 Linie: Endpunkt der Kante + 1/4 Bildbreite (da ~ 1/2 Streckenbreite)

Dekorator, Dataclass, sugaring
