...
Through the Raspberry Pi Imager the Pi OS Release 2020-05-27 was flashed onto the SD card.
The OS is a port of Debian with the Raspberry Pi Desktop.
In addition a ssh file and a wpa supplicant were stored in the boot partition.

WPA supplicant, armhf proc
