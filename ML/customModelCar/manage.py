...
if __name__ == '__main__':
    ...
    if args['train']:
        from train import preprocessFileList
        ...
        dataset = TubDataset('data', my_tranforms)
        dataloader = DataLoader(dataset, batch_size = 4096, shuffle = True, num_workers = 3)
        train(model_name, dataloader)

# NOTES
# V.add(kl, inputs=inputs, outputs=outputs, run_condition='run_pilot')
# inputs = ['cam/normalized/cropped']
# outputs = ['pilot/angle', 'pilot/throttle']
# implement kl.load(model_path) and kl.run()